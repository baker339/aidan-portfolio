...
export default function SiteNav() {
    ...
    return (
        <header className="sticky top-0 z-40 shrink-0 rounded-b-[1.5rem_2.25rem_1.25rem_2rem] border-b-[5px] border-ink bg-grape/90 shadow-[0_10px_0_0_rgba(26,15,46,0.45)] backdrop-blur-md">
